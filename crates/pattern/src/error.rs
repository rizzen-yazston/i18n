...
use i18n_utility::{ LocalisationData, LocalisationTrait, PlaceholderValue, LocalisationErrorTrait };
    ...
    fn localisation_data( &self ) -> LocalisationData {
        ...
        match self {
            ParserError::EndedAbruptly => {
                ...
                values.insert( "variant".to_string(), PlaceholderValue::String( "EndedAbruptly".to_string() ) ); 
            ...
            ParserError::UniqueNamed( identifier) => {
                ...
                let mut values = HashMap::<String, PlaceholderValue>::new();
                values.insert( "type".to_string(), type_string ); 
                values.insert( "variant".to_string(), PlaceholderValue::String( "UniqueNamed".to_string() ) ); 
                values.insert( "message".to_string(), PlaceholderValue::LocalisationData( message ) ); 
                LocalisationData {
                    component: "i18n_localiser".to_string(),
                    identifier: "error_format_enum".to_string(),
            ...
            ParserError::InvalidToken( position, token ) => {
                let mut message_values = HashMap::<String, PlaceholderValue>::new();
                message_values.insert( "position".to_string(), PlaceholderValue::Unsigned( *position as u128 ) );
                message_values.insert( "token".to_string(), PlaceholderValue::String( token.string.clone() ) );
                let message = LocalisationData {
                    component: "i18n_pattern".to_string(),
                ...
                let mut values = HashMap::<String, PlaceholderValue>::new();
                values.insert( "type".to_string(), type_string ); 
                values.insert( "variant".to_string(), PlaceholderValue::String( "InvalidToken".to_string() ) ); 
                values.insert( "message".to_string(), PlaceholderValue::LocalisationData( message ) ); 
                LocalisationData {
                    component: "i18n_localiser".to_string(),
                    identifier: "error_format_enum".to_string(),
            ...
            ParserError::MultiNumberSign( position ) => {
                ...
                let mut values = HashMap::<String, PlaceholderValue>::new();
                values.insert( "type".to_string(), type_string ); 
                values.insert( "variant".to_string(), PlaceholderValue::String( "MultiNumberSign".to_string() ) ); 
                values.insert( "message".to_string(), PlaceholderValue::LocalisationData( message ) ); 
                LocalisationData {
                    component: "i18n_localiser".to_string(),
                    identifier: "error_format_enum".to_string(),
            ...
            ParserError::UniquePattern( identifier) => {
                ...
                let mut values = HashMap::<String, PlaceholderValue>::new();
                values.insert( "type".to_string(), type_string ); 
                values.insert( "variant".to_string(), PlaceholderValue::String( "UniquePattern".to_string() ) ); 
                values.insert( "message".to_string(), PlaceholderValue::LocalisationData( message ) ); 
                LocalisationData {
                    component: "i18n_localiser".to_string(),
                    identifier: "error_format_enum".to_string(),
    ...
    fn localisation_data( &self ) -> LocalisationData {
        ...
        match self {
            ...
            CommandError::AlreadyExists( command ) => {
                let mut message_values = HashMap::<String, PlaceholderValue>::new();
                message_values.insert( "command".to_string(), PlaceholderValue::String( command.to_string() ) );
                let message = LocalisationData {
                    component: "i18n_pattern".to_string(),
                ...
                let mut values = HashMap::<String, PlaceholderValue>::new();
                values.insert( "type".to_string(), type_string ); 
                values.insert( "variant".to_string(), PlaceholderValue::String( "AlreadyExists".to_string() ) ); 
                values.insert( "message".to_string(), PlaceholderValue::LocalisationData( message ) ); 
                LocalisationData {
                    component: "i18n_localiser".to_string(),
                    identifier: "error_format_enum".to_string(),
            ...
            CommandError::NotFound( command ) => {
                ...
                let mut values = HashMap::<String, PlaceholderValue>::new();
                values.insert( "type".to_string(), type_string ); 
                values.insert( "variant".to_string(), PlaceholderValue::String( "NotFound".to_string() ) ); 
                values.insert( "message".to_string(), PlaceholderValue::LocalisationData( message ) ); 
                LocalisationData {
                    component: "i18n_localiser".to_string(),
                    identifier: "error_format_enum".to_string(),
            ...
            CommandError::InvalidType( command, index ) => {
                ...
                let mut values = HashMap::<String, PlaceholderValue>::new();
                values.insert( "type".to_string(), type_string ); 
                values.insert( "variant".to_string(), PlaceholderValue::String( "InvalidType".to_string() ) ); 
                values.insert( "message".to_string(), PlaceholderValue::LocalisationData( message ) ); 
                LocalisationData {
                    component: "i18n_localiser".to_string(),
                    identifier: "error_format_enum".to_string(),
