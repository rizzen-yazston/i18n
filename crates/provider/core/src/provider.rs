...
pub struct IdentifierDetails {
    pub languages: Vec<RefCount<LanguageTag>>, // The list of available languages for the identifier.
    pub default: RefCount<LanguageTag>,        // The default language for the identifier.
}
...
pub struct RepositoryDetails {
    pub languages: HashMap<RefCount<LanguageTag>, LanguageData>, // The unique list of all the components' languages.
    pub default: Option<RefCount<LanguageTag>>, // The default language of repository, usually the application component.
